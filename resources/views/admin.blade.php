...
@if (session()->has('success')) 
    ...
    <div class ="sucess"><p>{{ session('success') }} </p><a href="admin"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill equis" viewBox="0 0 16 16">
