...
@section('content')
    ...
    <div class ="sucess"><p>{{ session('success') }} </p><a href="blog"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill equis" viewBox="0 0 16 16">
    ...
    <form action="{{route('ask')}}" method="post" class = "custom-form pt-2">
        @csrf
        <input class = "input-blog" type="text" name = "titulo" placeholder = "Titulo de tu consulta..">
        <textarea class = "text-blog" name="pregunta" placeholder = "Exponga aqui.."></textarea>
